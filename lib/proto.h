...
extern void alloc_lfile(struct lsof_context *ctx, enum lsof_fd_type fd_type,
                        int num);
extern void clean_lfile(struct lsof_context *ctx, struct lfile *lf);
...
extern int ck_fd_status(struct lsof_context *ctx, enum lsof_fd_type fd_type,
                        int num);
extern enum lsof_error ck_file_arg(struct lsof_context *ctx, char *arg, int fv,
                                   int rs, struct stat *sbp,
...
extern int enter_cmd(char *opt, char *s);
...
extern void Error(struct lsof_context *ctx);
...
extern struct uxsin *find_uxsepti(struct lsof_context *ctx, struct lfile *lf);
...
extern void deinitialize(struct lsof_context *ctx);
...
extern void printname(int nl);
extern char *print_kptr(KA_T kp, char *buf, size_t bufl);
extern int print_proc(void);
extern void print_fd(enum lsof_fd_type fd_type, int fd_num, char *buf);
...
extern void print_iproto(enum lsof_protocol proto,
                         uint32_t unknown_proto_number, char *buf,
                         size_t buf_len);
...
extern void clean_mnt(struct lsof_context *ctx);
...
extern void enter_ip_proto(struct lsof_context *ctx, int p);
