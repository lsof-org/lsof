 ...
 * is #include'd from common.h, we must perform some early #include magic
 ...
 * inode element, fs_ino, in the lfile structure definition in common.h.
 */
 ...
 * printf specification modifier.  These need not be defined and common.h
