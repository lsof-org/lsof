...
extern struct l_vfs *readvfs,
    (struct lsof_context * ctx, KA_T ka struct vfs *la, struct vnode *lv);
...
#if solaris >= 110000
extern int process_VSOCK,
    (struct lsof_context * ctx, KA_T va struct vnode *v, struct sonode *so);
#endif /* solaris>=11000 */
